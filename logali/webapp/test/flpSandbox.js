		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Logali Project",
									"targetURL": "#logalilogali-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logalilogali-display": {
								"semanticObject": "logalilogali",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logali.logali",
									"url": sap.ui.require.toUrl("logali/logali")
								}
							}
						}
					}
